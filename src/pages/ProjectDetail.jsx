                ...
                {(() => {
                    ...
                    return (
                        <>
                            ...
                            />
                            <div className="fixed inset-0 z-0 bg-dark-bg/30 pointer-events-none" />
                            <div className="fixed inset-0 z-0 bg-gradient-to-t from-dark-bg via-dark-bg/60 to-transparent pointer-events-none" />
                        </>
                    );
                })()}

                <div className="max-w-4xl mx-auto pt-8 pb-16 px-4" onClick={handleBackdropClick}>
                    <div className="inline-block" onClick={(e) => e.stopPropagation()}>
                        <Link to="/" className="relative z-10 inline-flex items-center text-gray-400 hover:text-neon-blue mb-8 transition-colors cursor-pointer">
                            <ArrowLeft size={20} className="mr-2" /> Back to Works
                        </Link>
                    </div>

                    <motion.div
                        className="relative z-10 bg-cyber-gray border border-gray-800 p-6 overflow-hidden cursor-auto"
                    ...
                    >
                        ...
                        <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-neon-pink z-20 pointer-events-none"></div>
                        <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-neon-pink z-20 pointer-events-none"></div>
