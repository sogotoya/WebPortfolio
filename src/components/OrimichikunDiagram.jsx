        ...
        >
            ...
            <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto gap-5 relative z-10">
                ...
                <div className="w-full border border-orange-500/40 border-t-4 border-t-orange-500 bg-gradient-to-br from-orange-500/5 to-transparent p-5 rounded-md relative group transition-all duration-300">
                    <h4 className="text-white text-xl font-bold mb-4 font-orbitron text-center">Boss AI Context (Orchestrator)</h4>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {/* State Management */}
                        <div className="bg-gray-900/80 border border-gray-700/50 rounded flex flex-col items-center p-3 shadow-inner">
                            <span className="text-orange-300 text-xs font-bold mb-2 uppercase tracking-wider">State Management</span>
                            <span className="text-gray-300 text-sm whitespace-pre-line leading-relaxed text-center" dangerouslySetInnerHTML={{ __html: '・CurrentState\n・ChangeState()\n<span class="text-orange-400/90 text-[11px] block mt-1 font-bold">┗ 遷移の最終実行</span>' }}></span>
                        </div>
                        {/* Shared References */}
                        <div className="bg-gray-900/80 border border-gray-700/50 rounded flex flex-col items-center p-3 shadow-inner">
                            <span className="text-orange-300 text-xs font-bold mb-2 uppercase tracking-wider">Shared References</span>
                            <span className="text-gray-300 text-sm whitespace-pre-line leading-relaxed text-center">・Transform / Animator{'\n'}・Rigidbody2D{'\n'}・Player Reference</span>
                        </div>
                        {/* Runtime Data */}
                        <div className="bg-gray-900/80 border border-gray-700/50 rounded flex flex-col items-center p-3 shadow-inner">
                            <span className="text-orange-300 text-xs font-bold mb-2 uppercase tracking-wider">Runtime Data</span>
                            <span className="text-gray-300 text-sm whitespace-pre-line leading-relaxed text-center">・HP / Phase{'\n'}・Cooldown Timer</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-3/4 border border-yellow-500/40 hover:border-yellow-500 bg-gradient-to-b from-yellow-400/5 to-transparent p-4 rounded-md relative group transition-all duration-300">
                    ...
                    <h4 className="text-white text-lg font-bold mb-2 font-orbitron text-center">IState (Interface)</h4>
                    <p className="text-gray-300 text-sm text-center mb-3">
                        全ステート共通の振る舞いと遷移判定を定義
                    </p>
                    <div className="bg-gray-900/80 border border-yellow-700/50 rounded py-2 px-3 flex justify-center text-sm text-yellow-100 shadow-inner font-mono">
                        <span className="whitespace-pre-line leading-relaxed text-center" dangerouslySetInnerHTML={{ __html: '・OnEnter() / OnUpdate() / OnExit()\n・CheckTransition()\n<span class="text-orange-400/90 text-[11px] block mt-1 font-bold">┗ 次状態をContextへ提案</span>' }}></span>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row w-full justify-between gap-4">
                    ...
                    <div className="flex-1 flex flex-col items-center">
                        <div className="w-full border border-teal-600/50 bg-gradient-to-b from-gray-800/80 to-gray-900 p-4 rounded-md relative">
                            <h5 className="text-teal-400 font-bold font-orbitron mb-2 text-center border-b border-teal-800/50 pb-2">State_Move</h5>
                            <p className="text-gray-300 text-sm whitespace-pre-line leading-relaxed text-center">・距離維持ロジック{'\n'}・フレーム非依存移動</p>
                        </div>
                        ...
                        <div className="w-full border border-rose-600/50 bg-gradient-to-b from-gray-800/80 to-gray-900 p-4 rounded-md relative">
                            <h5 className="text-rose-400 font-bold font-orbitron mb-2 text-center border-b border-rose-800/50 pb-2">State_Roll</h5>
                            <p className="text-gray-300 text-sm whitespace-pre-line leading-relaxed text-center">・突進パターン{'\n'}・クールタイム管理</p>
                        </div>
