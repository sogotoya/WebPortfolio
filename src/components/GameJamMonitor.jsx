        ...
        >
            <AnimatePresence initial={false} mode="wait" custom={slideDirection}>
                <motion.img
                    ...
                    alt={title}
                    className={`absolute inset-0 w-full h-full pointer-events-none ${typeof imageUrls[imageIndex] === 'object' && imageUrls[imageIndex].fit === 'contain' ? 'object-contain' : 'object-cover'}`}
                    variants={variants}
                    initial="enter"
                    animate="center"
                    exit="exit"
